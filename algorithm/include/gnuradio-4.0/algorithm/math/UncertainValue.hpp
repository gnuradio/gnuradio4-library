#ifndef GNURADIO_ALGORITHM_MATH_UNCERTAINVALUE_HPP
#define GNURADIO_ALGORITHM_MATH_UNCERTAINVALUE_HPP
...
template<arithmetic_or_complex_like T>
struct is_arithmetic_sample<UncertainValue<T>> : std::true_type {};
...
#endif // GNURADIO_ALGORITHM_MATH_UNCERTAINVALUE_HPP
